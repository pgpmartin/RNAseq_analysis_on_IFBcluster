...
#SBATCH --output=/shared/projects/form_2022_07/TD_RNAseq/log/04_b_bamscale_filteredReads_%A_%a.out
#SBATCH --error=/shared/projects/form_2022_07/TD_RNAseq/log/04_b_bamscale_filteredReads_%A_%a.err
#SBATCH --array=0-5

...
Le test généralement utilisé pour évaluer cela est un [test exact de Fisher](https://fr.wikipedia.org/wiki/Test_exact_de_Fisher) basé sur la [loi hypergéométrique](https://fr.wikipedia.org/wiki/Loi_hyperg%C3%A9om%C3%A9trique).  
